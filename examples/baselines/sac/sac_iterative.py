...
# Import RewardWrapper from ppo directory (shared)
...
if __name__ == "__main__":
    ...
    reward_wrapper_train = RewardWrapper(envs, env_id=args.env_id)
    reward_wrapper_eval = RewardWrapper(eval_envs, env_id=args.env_id)
                    ...
                    try:
                        ...
                        if suggestions and suggestions.get("type") == "params":
                            ...
                            if new_params:
                                ...
                                # Clear replay buffer to avoid stale rewards from old weights.
                                # Old transitions have rewards computed with old weights;
                                # training on mixed old/new rewards causes Q-value divergence.
                                rb.clear()
                                print(f"[SAC] Replay buffer cleared after weight change "
                                      f"(old data had rewards from previous weights)")
